...
class StepComponent extends Component {
  ...
  render() {
    ...
    return (
  <Step.Group ordered>
    <Step active={step === 'createOrder'} completed={step !== 'createOrder'}>
      <Step.Content>
    ...
    <Step active={step === 'confirmation'} completed={step === 'status' || step === 'summary'}>
      <Step.Content>
    ...
    <Step active={step === 'status'} completed={step === 'summary'}>
      <Step.Content>
